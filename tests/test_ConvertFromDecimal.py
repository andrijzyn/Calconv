...
from main import convert_from_decimal


class TestConvertFromDecimal(unittest.TestCase):
    def test_binary_conversion(self):
        result, steps = convert_from_decimal(10, 2)
